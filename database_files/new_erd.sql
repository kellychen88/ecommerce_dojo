...
-- Schema e_commerce_products
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `e_commerce_products` DEFAULT CHARACTER SET utf8 ;
...
-- -----------------------------------------------------
-- Table `e_commerce_products`.`image`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `e_commerce_products`.`image` (
